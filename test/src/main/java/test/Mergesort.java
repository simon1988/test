...
public class Mergesort {
	 ...
	 * array. The <CODE>String</CODE> arguments (<CODE>args</CODE>) are not used
	 ...
	 * @param <CODE>first</CODE> the start index for the portion of the array
	 *        that will be sorted
	 * @param <CODE>n</CODE> the number of elements to sort <dt>
	 *        <b>Precondition:</b>
	 *        <dd>
	 *        <CODE>data[first]</CODE> through <CODE>data[first+n-1]</CODE> are
	 *        valid parts of the array.
	 *        <dt><b>Postcondition:</b>
	 *        <dd>
	 *        If <CODE>n</CODE> is zero or negative then no work is done.
	 *        Otherwise, the elements of </CODE>data</CODE> have been rearranged
	 *        so that
