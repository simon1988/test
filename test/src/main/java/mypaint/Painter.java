...
/*----------------------------------------------------------------------------*/	
	public class MenuButtonListener implements ActionListener
	{
		public void actionPerformed(ActionEvent event)
		{
			...
			{
				JOptionPane.showMessageDialog(Painter.this,"about","My Paint",JOptionPane.INFORMATION_MESSAGE);
				canvasPanel.repaint();
			}
...
/*----------------------------------------------------------------------------*/
	public static void main(String args[])
	{
		...
		frame.setBounds(dim.width/4, dim.height/4, dim.width/2, dim.height/2);
